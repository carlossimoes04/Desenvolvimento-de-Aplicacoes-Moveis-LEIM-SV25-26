...
import dam_A51696.picsumgallerycompose.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val database by lazy { dam_A51696.picsumgallerycompose.core.data.AppDatabase.getDatabase(applicationContext) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fabFavorites.setOnClickListener {
            ...
            val dialogView = layoutInflater.inflate(dam_A51696.picsumgallerycompose.R.layout.dialog_favorites, null)
            bottomSheet.setContentView(dialogView)

            val recyclerFav = dialogView.findViewById<androidx.recyclerview.widget.RecyclerView>(dam_A51696.picsumgallerycompose.R.id.recyclerFavorites)
