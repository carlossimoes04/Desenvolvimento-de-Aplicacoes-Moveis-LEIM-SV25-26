...
/*
Quando o WeatherAPIClient faz uma chamada à API, a resposta chega num formato JSON,
que tem, por exemplo, este aspeto:
...
Para o Kotlin poder ler esses dados, é necessária a tradução de textos JSON para objetos Kotlin.
Este processo chama-se Serialização.
 */
