...
class AIAssistantKimi(override val properties: Properties) : AIAssistant {
    ...
    override fun buildRequest(prompt: String): Request {
        ...
        val requestBody = JSONObject()
            ...
            .put("max_tokens", getMaxTokensOrDefault(16384))
            .put("temperature", getTemperatureOrDefault(1.0))
            .put("top_p", 1.0)
            .put("stream", false)
            .put("chat_template_kwargs", JSONObject().put("thinking", false)) // true para ligar o thinking | false para desligar
            .toString()
